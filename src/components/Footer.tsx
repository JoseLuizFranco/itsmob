    ...
    <footer className="bg-blue-900 text-white mt-8">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-bold">ItsMob</h3>
            </div>
            <p className="text-blue-200 mb-4">
              Sua solução completa para aluguel de veículos no Brasil, com as melhores opções 
              para curto e médio prazo.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-blue-200 hover:text-orange-300 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-blue-200">
              ...
              <li><a href="#" className="hover:text-orange-300 transition-colors">Termos e Condições</a></li>
              <li><a href="#" className="hover:text-orange-300 transition-colors">Política de Privacidade</a></li>
              <li><a href="#" className="hover:text-orange-300 transition-colors">Perguntas Frequentes</a></li>
          ...
          <div id="contato">
            ...
            <ul className="space-y-3 text-blue-200">
              ...
              <li className="flex items-center">
                ...
                <span>contato@itsmob.com.br</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-blue-800 mt-8 pt-6 text-center text-blue-300">
          <p>&copy; {new Date().getFullYear()} ItsMob. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
